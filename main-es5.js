...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
  ...
  function srcAppAppModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    AppModule.ɵinj = _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵdefineInjector"]({
      ...
      providers: [],
      imports: [[_angular_platform_browser__WEBPACK_IMPORTED_MODULE_0__["BrowserModule"], _app_routing_module__WEBPACK_IMPORTED_MODULE_1__["AppRoutingModule"], _angular_common_http__WEBPACK_IMPORTED_MODULE_4__["HttpClientModule"]]]
    });

    (function () {
      (typeof ngJitMode === "undefined" || ngJitMode) && _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵsetNgModuleScope"](AppModule, {
        declarations: [_app_component__WEBPACK_IMPORTED_MODULE_2__["AppComponent"], _chart_chart_component__WEBPACK_IMPORTED_MODULE_5__["ChartComponent"]],
        imports: [_angular_platform_browser__WEBPACK_IMPORTED_MODULE_0__["BrowserModule"], _app_routing_module__WEBPACK_IMPORTED_MODULE_1__["AppRoutingModule"], _angular_common_http__WEBPACK_IMPORTED_MODULE_4__["HttpClientModule"]]
      });
    })();
    /*@__PURE__*/
  ...
  function srcAppChartChartComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _amcharts_amcharts4_plugins_sunburst__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
    /*! @amcharts/amcharts4/plugins/sunburst */
    "./node_modules/@amcharts/amcharts4/plugins/sunburst.js");
    /* harmony import */


    var _services_backend_api_service__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(
    ...
    /*#__PURE__*/
    function () {
      function ChartComponent(backendApiService) {
      ...
      _createClass(ChartComponent, [{
        ...
        value: function ngOnInit() {
          this.backendApiService.getAllDataByCountry("india,Nepal,Bangladesh,Pakistan,Bhutan,Sri Lanka,Maldives").subscribe(function (data) {
            var allData = data;
            console.log(allData);

            var chart = _amcharts_amcharts4_core__WEBPACK_IMPORTED_MODULE_1__["create"]("chartdiv", _amcharts_amcharts4_plugins_sunburst__WEBPACK_IMPORTED_MODULE_3__["Sunburst"]);

            chart.radius = _amcharts_amcharts4_core__WEBPACK_IMPORTED_MODULE_1__["percent"](100); // Make colors more distinctive

            chart.colors.step = 2; // Add multi-level data

            chart.data = [{
              name: "India",
              children: [{
                name: "Total Cases ",
                value: allData[0].cases,
                children: [{
                  name: "Recovered",
                  value: allData[0].recovered
                }, {
                  name: "Deaths",
                  value: allData[0].deaths
                }, {
                  name: "Active",
                  value: allData[0].active
                }]
              }]
            }, {
              name: "Nepal",
              children: [{
                name: "Total Cases ",
                value: allData[1].cases,
                children: [{
                  name: "Recovered",
                  value: allData[1].recovered
                }, {
                  name: "Deaths",
                  value: allData[1].deaths
                }, {
                  name: "Active",
                  value: allData[1].active
                }]
              }]
            }, {
              name: "Bangladesh",
              children: [{
                name: "Total Cases ",
                value: allData[2].cases,
                children: [{
                  name: "Recovered",
                  value: allData[2].recovered
                }, {
                  name: "Deaths",
                  value: allData[2].deaths
                }, {
                  name: "Active",
                  value: allData[2].active
                }]
              }]
            }, {
              name: "Pakistan",
              children: [{
                name: "Total Cases ",
                value: allData[3].cases,
                children: [{
                  name: "Recovered",
                  value: allData[3].recovered
                }, {
                  name: "Deaths",
                  value: allData[3].deaths
                }, {
                  name: "Active",
                  value: allData[3].active
                }]
              }]
            }, {
              name: "Bhutan",
              children: [{
                name: "Total Cases ",
                value: allData[4].cases,
                children: [{
                  name: "Recovered",
                  value: allData[4].recovered
                }, {
                  name: "Deaths",
                  value: allData[4].deaths
                }, {
                  name: "Active",
                  value: allData[4].active
                }]
              }]
            }, {
              name: "Sri Lanka",
              children: [{
                name: "Total Cases ",
                value: allData[5].cases,
                children: [{
                  name: "Recovered",
                  value: allData[5].recovered
                }, {
                  name: "Deaths",
                  value: allData[5].deaths
                }, {
                  name: "Active",
                  value: allData[5].active
                }]
              }]
            }, {
              name: "Maldives",
              children: [{
                name: "Total Cases ",
                value: allData[6].cases,
                children: [{
                  name: "Recovered",
                  value: allData[6].recovered
                }, {
                  name: "Deaths",
                  value: allData[6].deaths
                }, {
                  name: "Active",
                  value: allData[6].active
                }]
              }]
            }]; // Define data fields
            ...
            level2.hiddenInLegend = true; // Add legend
    ...
    ChartComponent.ɵfac = function ChartComponent_Factory(t) {
      return new (t || ChartComponent)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_services_backend_api_service__WEBPACK_IMPORTED_MODULE_4__["BackendApiService"]));
    };
    ...
    (function () {
      _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](ChartComponent, [{
        ...
        return [{
          type: _services_backend_api_service__WEBPACK_IMPORTED_MODULE_4__["BackendApiService"]
        }];
      }, null);
    })();
    /***/
  ...
  function srcAppServicesBackendApiServiceTs(module, __webpack_exports__, __webpack_require__) {
    ...
    function () {
      ...
      _createClass(BackendApiService, [{
        key: "getAllDataByCountry",
        value: function getAllDataByCountry(country) {
  ...
  function _(module, exports, __webpack_require__) {
    ...
    /*! F:\covid-subcontinent\covid\src\main.ts */
    "./src/main.ts");
    /***/
  }
}, [[0, "runtime", "vendor"]]]);
